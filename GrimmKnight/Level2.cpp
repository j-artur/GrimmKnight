...
void Level2::Init()
{
    ...
    GrimmKnight::audio->Play(CAVE_WIND, true);
...
{
    GrimmKnight::audio->Stop(CAVE_WIND);
    delete background;
    delete foreground;
...
void Level2::EnterFrom(LevelId id)
{
    ...
    case LEVEL4:
        enteringFrom = LEVEL4;
        GrimmKnight::player->MoveTo(1280.0f, 226.0f);
    ...
    case LEVEL1:
        enteringFrom = LEVEL1;
        GrimmKnight::player->MoveTo(0.0f, 706.0f);
        GrimmKnight::player->State(WALKING);
    ...
    default:
        ...
        GrimmKnight::player->MoveTo(112.0f, 706.0f);
        GrimmKnight::player->Dir(H_RIGHT);
        break;
    }
}
